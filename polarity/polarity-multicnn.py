...
DATASET_JSON = "./dataset/full-corpus-clean.json"
...
#    y_val = y[:limit]
    ...
    flatten = Flatten(name = 'polarity_flatten')(merged)
#    batch_norm = BatchNormalization()(flatten)
    dense_1 = Dense(256, activation = 'relu',name = 'polarity_dense_1')(flatten)
    drop_1 = Dropout(0.8, name = 'polarity_drop_1')(dense_1)
    dense_2 = Dense(256, activation = 'relu',name = 'polarity_dense_2')(drop_1)
    drop_2 = Dropout(0.8, name = 'polarity_drop_2')(dense_2)
    output_irony = Dense(4, activation='softmax', name='main_output')(drop_2)
